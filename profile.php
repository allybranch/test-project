...
<html lang='en'>
  ...
  <body>
    ...
    <h2 id='listcount'> </h2>
      ...
      <button class="btn btn-lg btn-primary form-btn" onclick="ViewLists()">My Lists</button>
      
      <button class="btn btn-lg btn-primary form-btn" onclick="ViewFriends()">My Friends</button>
    </div>
      ...
      <div id='profile-title'>
        ...
        <div id='profile-lists'>          
          ...
          <div id='NewListBtn'> 
          <!-- this next line is supposedly wrong????  it doesnt like the name and the closing tag--> 
          ...
          <table id='mylists' class='table'>
            ...
            <tr>
              ...
              <div class="owl-carousel owl-theme">
                ...
                <button onclick="ViewLists()">View My Lists</button>
                <button onclick="ViewFriends()">View My Friends</button>
                <h2 id="profile-title"> My Lists </h2>
                <div id="profile-lists">
                  <h4 class="list-title"> Currently Watching </h4>
                  <div class="owl-carousel owl-theme">
                      <div class="item">
...
/* Toggle Buttons */ 
    ...
    function ViewFriends(){
      var lists = document.getElementById("profile-lists");
      var friends = document.getElementById("profile-friends");
      document.getElementById("profile-title").innerHTML =  "<h1> My Friends </h1>";

      lists.style.display = "none";
      friends.style.display = "block";
    }

     /* Add a List (aka a row to the table) */
    function newList(){

      //get the table
      var listTable = document.getElementById('mylists');

      //insert the row
      var newRow=listTable.insertRow(listTable.rows.length);

      //add the html code to the new row
      //the html code is in a script block at the bottom of the file     
     newRow.innerHTML=document.getElementById('carousel').innerHTML;
     
     //you can also embed html in a string but i like the above method better
    //  var carousel ='<h4 class="list-title">' + 'New List' + '</h4>' +  '<div class="owl-carousel owl-theme">' + '<div class="item">'+
    //       '<img src="https://occ-0-2433-2430.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABVpWLG11PojFPeqpJyc14l1iTPUtb-7K9nONUphboJDuTEUdXQNfPgHzcttWQhMCSvsS6SSo5qmheyWPwmLPGmqpfCGXV8MvxrJMeLUbMgxLFAOgxWcw8on2bnW3.jpg?r=748" >'+'</img>'+
    //               '</div>'+'</div>';

    //   newRow.innerHTML=carousel;

    }

    /* Arrow function */ 
    var list = document.getElementById('mylists');
      var numRows=list.rows.length;
      console.log(numRows);
      var string = lists.rows.length => "You have "+ (lists.rows.length)+ " lists!";
      //(numRows) => { "You have "+ numRows+ " lists!";};
        
        

      console.log(string());
      document.getElementById('listcount').value=string();
      //console.log(document.getElementById('listcount').value);
      
     
  </script>

    <!-- Add a new list aka add a row -->
  <script type="text/template" id='carousel'>
    ...
    <div class="owl-carousel owl-theme">
        <div class="item">
            <img src="https://occ-0-2433-2430.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABVpWLG11PojFPeqpJyc14l1iTPUtb-7K9nONUphboJDuTEUdXQNfPgHzcttWQhMCSvsS6SSo5qmheyWPwmLPGmqpfCGXV8MvxrJMeLUbMgxLFAOgxWcw8on2bnW3.jpg?r=748" />
        </div>
    </div>
