...
/* Toggle Buttons */ 
    function ViewLists(){
      ...
      listBtn=document.getElementById('NewListBtn');
    ...
    function ViewFriends(){
      ...
      title.style.padding='50px, 50px, 50px, 50px';
  ...
  <script type='text/template' id='carousel'> 
    ...
    <div style='max-width: 320px' class="owl-carousel owl-theme">
      <div class='item' style='height:85px !important; width:150px'>
