...
<html lang='en'>
  ...
  <body>
    ...
    <h2 id='listcount'> Welcome Back! </h2>
...
/* Toggle Buttons */ 
    ...
    function newList(){
     ...
     newRow.innerHTML=document.getElementById('carousel').innerHTML;
      ...
      var string = numRows => "You have "+ numRows + " lists!"; //arrow function
      document.getElementById('listcount').innerHTML= "<h1>"+ string(numRows)+ "</h2>";
